...
const Footer = () => {
  return (
    // <!-- Footer container -->
    <footer className="bg-black text-center text-natural dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      <div className="bg-black text-natural p-6 text-center">
        ...
        <a className="font-semibold" href="https://blockchainalpha.com/">
          Blockchain Alpha
        </a>
      </div>
    </footer>
